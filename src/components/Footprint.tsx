              ...
              <div className="space-y-2">
                {[
                  ...
                  >
                    ...
                    <span className="text-lg font-bold text-accent-2 tabular-nums">
                      {repo.count}
                    </span>
                  </motion.div>
                ))}
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-text-dim mb-3">
                  ...
                  GitHub account are no longer publicly accessible. This shows
                  sustained backend delivery across multiple release cycles.
                </p>
